...
const Input = (props) => {
    ...
    //const handleInputSubmit = event => { event.preventDefault()}
        ...
        <div className="flex justify-center bg-yellow w-full py-9 not-italic text-lg ">
            <div className="w-4/6 relative">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <input {...register("value",{required: 'This is required',pattern:/^[a-z/\s/ ]+$/i})} className=" px-16 py-4 rounded-full text-2xl w-full lowercase" type="text"/>
                    ...
                    <button type="submit" className="bg-purple text-white rounded-full p-1 absolute top-2 right-2">
